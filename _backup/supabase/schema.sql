...
-- Para desarrollo ágil inicial, habilitamos escritura si el usuario está autenticado
CREATE POLICY "auth_insert_matches" ON matches FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_update_matches" ON matches FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_rosters" ON match_rosters FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_update_rosters" ON match_rosters FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_delete_rosters" ON match_rosters FOR DELETE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_goals" ON goals FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_delete_goals" ON goals FOR DELETE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_cards" ON cards FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_delete_cards" ON cards FOR DELETE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_update_players" ON players FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_players" ON players FOR INSERT WITH CHECK (auth.role() = 'authenticated');
